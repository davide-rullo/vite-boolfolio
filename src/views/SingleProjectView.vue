                ...
                <div v-if="!loading">
                    <div class="row">
                        <div class="info pt-3 pb-5">
                            ...
                            <div class="github">
                                <h5>Link Github:</h5>
                                <a :href="project.github_link"><svg xmlns="http://www.w3.org/2000/svg" height="3em"
                        ...
                        <img class="img-fluid pb-5" width="400"
                            :src="'http://127.0.0.1:8000/storage/' + project.cover_image" alt="">
